...
<div class="container-cvenligne">
    <div class="boxoftwo">
        ...
        <?php
            ...
            <a href="https://github.com/Oceanesvr/htAuto" class="buttonGithub" target="_blank">lien GitHub</a>
        ...
        <div class="right">
            <img src="images/ht1.png" alt="">
            <img src="images/ht2.png" alt="">
            <img src="images/ht3.png" alt="">
